...
1. **006 · Apartado de ONGs y organizaciones relacionadas con perros** — nuevo apartado en la página principal. Todavía sin `spec.md`/`plan.md`/`tasks.md`; se concreta cuando se aborde (qué contenido exacto, de dónde salen los datos de las organizaciones, dónde se ubica en la home).
